...
const ChatView = () => {
  return (
    <div className="w-full h-full bg-white text-gray-900 shadow-lg border border-black border-4 rounded-3xl flex flex-col transition-all duration-300 overflow-hidden">
